// components/professor/Cadastro.jsx
import React, { useState, useEffect } from "react";
import api from "../../api/api"; // Importa o objeto api
  ...
  const fetchProfessores = async () => {
    try {
      ...
      const availableProfessores = allProfessores.filter(
        (professor) => !professor.curso // Verifica se o campo curso é null
      );

      setProfessores(allProfessores); // Armazena todos os professores
      setProfessoresDisponiveis(availableProfessores); // Armazena apenas os disponíveis
    } catch (error) {
